proc vsimulink {args} {
  lappend sllibarg -foreign \{simlinkserver \{D:/Matlab/toolbox/edalink/extensions/modelsim/windows32/liblfmhdls_gcc421vc12.dll\}
...
proc vsimmatlab {args} {
  lappend mllibarg -foreign \{matlabclient \{D:/Matlab/toolbox/edalink/extensions/modelsim/windows32/liblfmhdlc_gcc421vc12.dll\}
  lappend mllibarg \}
  lappend mlinput 
...
proc vsimmatlabsysobj {args} {
  lappend sllibarg -foreign \{matlabsysobjserver \{D:/Matlab/toolbox/edalink/extensions/modelsim/windows32/liblfmhdls_gcc421vc12.dll\}
  if {[catch {lsearch -exact $args -socket} idx]==0  && $idx >= 0} {
    set socket [lindex $args [expr {$idx + 1}]]
    set args [lreplace $args $idx [expr {$idx + 1}]]
    append socketarg " \; -socket " "$socket"
